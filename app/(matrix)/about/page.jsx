...
export const metadata = {
  title: "About - Matrix",
  description: "About the Matrix simulation",
};
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-matrix-panel border-matrix border-matrix-green border-opacity-30 p-6 space-y-4">
          <p className="text-matrix-green-dim leading-relaxed">
            Matrix is an advanced agent-based simulation system that models
            complex social, economic, and environmental dynamics in a virtual
            world. The system tracks individual agents as they interact, work,
            trade, and navigate their environment.
          </p>
          ...
          <p className="text-matrix-green-dim leading-relaxed">
            The simulation runs in real-time, with agents making autonomous
            decisions based on their needs, goals, and environmental conditions.
            Districts manage resources like food, water, and energy, while
            agents engage in activities ranging from work and trade to social
          ...
          <p className="text-matrix-green-dim leading-relaxed">
            Built with Next.js 16, React, and modern web technologies. The
            backend runs on Python with Tensor-based computation, providing
            RESTful APIs and WebSocket connections for live data streaming.
          </p>
          ...
          <p className="text-matrix-green-dim leading-relaxed">
            The simulation runs continuously in the background as long as server
            bills are paid. We try to maintain state persistence, but eventually
            there will be a need for reset. Like the Matrix, you can only reload
            it so many times... approximately 5 times, to be precise.
          ...
          <div className="mt-6 p-4 bg-matrix-dark border border-matrix-green border-opacity-20">
            <p className="text-matrix-green-dim text-xs font-mono leading-relaxed">
              <span className="text-matrix-green">[SYSTEM MESSAGE]</span> The
              Matrix has you. Follow the white rabbit. Knock, knock, Neo.
            </p>
          </div>
        </div>
