    ...
    const loadImage = async (info = null) => {
      ...
      try {
        ...
        if (info && info.next_generation_in_seconds !== undefined) {
          ...
          nextGenerationTime = generatedAt + 10 * 60 * 1000; // 10 minutes fallback
        }
    ...
    <>
      <div>
        ...
        <p className="mb-3">
          ...
          regenerated every 10 minutes to reflect the latest state of the world.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="list-disc list-inside mb-3 space-y-1 ml-2">
          ...
          <li>
            <strong>Auto-refresh:</strong> New images are generated every 10
            minutes
          </li>
          <li>
